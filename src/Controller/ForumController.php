...
class ForumController extends TwigAwareController implements FrontendZoneInterface
{
    /** @var Query */
    private $query;
    ...
    public function forumPosts(Request $request, \Bolt\Configuration\Config $coreConfig): Response
    {

        ($coreConfig->get('general/sortfields/posts'));
